...
#define STRING_CONFIG_H_AUTHOR "(Mike G, Ender-3Pro_SKR14)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 PRO SKR1.4"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 50.1, -4.6, 0 }
