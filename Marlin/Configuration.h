...
#define STRING_CONFIG_H_AUTHOR "(mikejr83, Makertech3D AXIS)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AXIS SKR 1.4 Turbo"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 200 }
...
#define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   6.5  // G26 Q (retraction) used by default between mesh test elements.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MAX_POS - 10), 10 }
